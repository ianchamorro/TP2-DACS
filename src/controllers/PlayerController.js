...
export class PlayerController {
    ...
    async updatePlayer(req,res){
        try {
            const updatedPlayer = await PlayerRepoInstance.updatePlayer(req.params.id,req.body);
    ...
    try {
        const deletedPlayer = await PlayerRepoInstance.deletePlayer(req.params.id);
